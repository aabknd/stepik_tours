...
def main_view(request):
    ...
    context = {"description": description,
               "subtitle": subtitle,
               "tour1": tours[numbers[0]],
               "tour2": tours[numbers[1]],
               "tour3": tours[numbers[2]],
               "tour4": tours[numbers[3]],
               "tour5": tours[numbers[4]],
               "tour6": tours[numbers[5]],
               "addr1": numbers[0],
               "addr2": numbers[1],
               "addr3": numbers[2],
               "addr4": numbers[3],
...
def departure_view(request, departure):
    tours_list = [i + 1 for i in range(len(tours)) if tours[i + 1]["departure"] == departure]
    tours_amount = len(tours_list)
    min_price_tour = min([tours[i + 1]["price"] for i in range(len(tours)) if tours[i + 1]["departure"] == departure])
    max_price_tour = max([tours[i + 1]["price"] for i in range(len(tours)) if tours[i + 1]["departure"] == departure])
    min_nights_tour = min([tours[i + 1]["nights"] for i in range(len(tours)) if tours[i + 1]["departure"] == departure])
    max_nights_tour = max([tours[i + 1]["nights"] for i in range(len(tours)) if tours[i + 1]["departure"] == departure])
    if tours_amount < 4:
        tours_list.append(tours_list[0])

    context = {"departures": departures[departure],
               "tours_amount": tours_amount,
               "min_price_tour": min_price_tour,
               "max_price_tour": max_price_tour,
               "min_nights_tour": min_nights_tour,
               "max_nights_tour": max_nights_tour,
               "tour1": tours[tours_list[0]],
               "tour2": tours[tours_list[1]],
               "tour3": tours[tours_list[2]],
               "tour4": tours[tours_list[3]],
               "tour5": tours[tours_list[1]],
               "tour6": tours[tours_list[2]],
               "addr1": tours_list[0],
               "addr2": tours_list[1],
               "addr3": tours_list[2],
               "addr4": tours_list[3],
...
def tour_view(request, tour):
    context = {"tour": tours[tour], "departure": departures[tours[tour]["departure"]]}
